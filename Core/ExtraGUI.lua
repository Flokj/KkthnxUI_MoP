...
function ExtraGUI:RegisterExampleConfigs()
	...
	self:RegisterExtraConfig("Inventory.ItemFilter", function(parent)
		...
		-- Filter Ammo Switch
		local ammoSwitch = self:CreateSwitch(parent, "Inventory.FilterAmmo", "Filter Ammo Items", "Filter ammo items", UpdateBagStatus)
		ammoSwitch:SetPoint("TOPLEFT", 0, yOffset)
		yOffset = yOffset - 35

		-- Filter BOE Switch
		local warbandSwitch = self:CreateSwitch(parent, "Inventory.FilterBOE", "Filter BoE", "Filter bind-on-equip items", UpdateBagStatus)
		...
		local consumableSwitch = self:CreateSwitch(parent, "Inventory.FilterConsumable", "Filter Consumable Items", "Filter consumable items (food, potions, etc.)", UpdateBagStatus)
		consumableSwitch:SetPoint("TOPLEFT", 0, yOffset)
		yOffset = yOffset - 35

		-- Filter EquipSets Switch
		local equipSetsSwitch = self:CreateSwitch(parent, "Inventory.FilterEquipSet", "Filter EquipSet", "Filter equipment sets", UpdateBagStatus)
		equipSetsSwitch:SetPoint("TOPLEFT", 0, yOffset)
		yOffset = yOffset - 35

		-- Filter Equipment Switch
		local equipmentSwitch = self:CreateSwitch(parent, "Inventory.FilterEquipment", "Filter Equipment Items", "Filter equipment items", UpdateBagStatus)
		equipmentSwitch:SetPoint("TOPLEFT", 0, yOffset)
		yOffset = yOffset - 35

		-- Filter Trade Goods Switch
		local goodsSwitch = self:CreateSwitch(parent, "Inventory.FilterGoods", "Filter Goods Items", "Filter trade goods and crafting materials", UpdateBagStatus)
	...
	self:RegisterExtraConfig("Unitframe.ShowPlayerLevel", function(parent)
		...
		local hideMaxLevelSwitch = self:CreateSwitch(parent, "Unitframe.HideMaxPlayerLevel", L["Hide Player Level At Max Level"], L["Automatically hide the player level text when you reach maximum level (90)"])
