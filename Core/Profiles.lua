...
function Profiles:Enable()
	...
	self.Description:SetFontObject(K.UIFont)
	...
	self.Status:SetFontObject(K.UIFont)
	...
	self.EditBox:CreateBackdrop(-4, 4, 4, -4, nil, nil, nil, nil, nil, { 102 / 255, 157 / 255, 255 / 255 })
	...
	self.Apply.Text:SetFontObject(K.UIFont)
	...
	self.Reset.Text:SetFontObject(K.UIFont)
