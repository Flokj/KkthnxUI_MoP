...
function Module:CreateAFKCam()
	...
	AFKMode.bottom:SetPoint("BOTTOM", AFKMode, "BOTTOM", 0, -K.BorderSize)
	AFKMode.bottom:SetWidth(K.ScreenWidth + (K.BorderSize * 2))
	AFKMode.bottom:SetHeight(K.ScreenHeight * 0.08)
