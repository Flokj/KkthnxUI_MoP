...
local GetBestMapForUnit = GetBestMapForUnit
local GetAtlasInfo = GetAtlasInfo
local GetVignetteInfo = GetVignetteInfo
local GetVignettePosition = GetVignettePosition
...
function Module:RareAlert_Update(id)
	...
	if C["Announcements"].AlertInChat then
		...
		local position = mapID and GetVignettePosition(info.vignetteGUID, mapID)
