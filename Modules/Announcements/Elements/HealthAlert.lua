...
local function checkPlayerHealth()
	if not shouldCheckHealth() or UnitIsDead("player") then return end
...
local function checkPetHealth()
	if not shouldCheckHealth() or not validPetClasses[K.Class] or UnitIsDead("pet") then return end
