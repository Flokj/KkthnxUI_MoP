...
local function renameChatStrings()
	...
	_G.LOOT_ROLL_STARTED ="|HlootHistory:%d|h[L]|h: %s"
	_G.LOOT_ROLL_PASSED ="|HlootHistory:%d|h[L]|h: %s passed %s."
	_G.LOOT_ROLL_PASSED_SELF ="|HlootHistory:%d|h[L]|h: You passed: %s."
	...
	--_G.LOOT_ROLL_WON_NO_SPAM_NEED = "|HlootHistory:%d|h[L]|h %s wins %s |cff818181(|cfff76227\"Need\"|r – %d)|r"
	--_G.LOOT_ROLL_WON_NO_SPAM_GREED = "|HlootHistory:%d|h[L]|h %s wins %s |cff818181(|cff08ed84\"Greed\"|r – %d)|r"
	--_G.LOOT_ROLL_YOU_WON_NO_SPAM_NEED = "|HlootHistory:%d|h[L]|h You won %s |cff818181(|cfff76227\"Need\"|r – %d)|r"
	--_G.LOOT_ROLL_YOU_WON_NO_SPAM_GREED = "|HlootHistory:%d|h[L]|h You won %s |cff818181(|cff08ed84\"Greed\"|r – %d)|r"
	--_G.LOOT_ROLL_ROLLED_GREED = "|HlootHistory:%1$d|h[L]|h: %3$s. - |cff818181(|cff08ed84\"Greed\"|r %4$s: |cffffd700%2$d|r)|r"
	--_G.LOOT_ROLL_ROLLED_NEED = "|HlootHistory:%1$d|h[L]|h: %3$s. - |cff818181(|cfff76227\"Need\"|r %4$s: |cffffd700%2$d|r)|r"
	--_G.LOOT_ROLL_GREED = "|HlootHistory:%d|h[L]|h: %s |cff08ed84\"Greed\"|r - %s."
	--_G.LOOT_ROLL_NEED = "|HlootHistory:%d|h[L]|h: %s |cfff76227\"Need\"|r - %s."
	--_G.LOOT_ROLL_GREED_SELF = "|HlootHistory:%d|h[L]|h: %s. You say: |cff08ed84\"Greed\"|r"
	--_G.LOOT_ROLL_NEED_SELF ="|HlootHistory:%d|h[L]|h: %s. You say: |cfff76227\"Need\"|r"
