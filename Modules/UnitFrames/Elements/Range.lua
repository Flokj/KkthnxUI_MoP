...
-- Global caching
local string_find, UnitIsUnit, UnitInParty, UnitInRaid, GetNumGroupMembers, IsInRaid, UnitIsPlayer, UnitInPhase, UnitInRange, UnitCanAttack, UnitIsConnected = string.find, UnitIsUnit, UnitInParty, UnitInRaid, GetNumGroupMembers, IsInRaid, UnitIsPlayer, UnitInPhase, UnitInRange, UnitCanAttack, UnitIsConnected
