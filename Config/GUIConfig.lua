...
local function CreateInventoryCategory()
	...
	GUI:CreateSwitch(bagBarSection, "Inventory.BagBarMouseover", "Show Bag Bar On Mouseover")
...
local function CreateMiscCategory()
	...
	GUI:CreateSlider(threatBarSection, "Misc.ThreatBarRows", "Number of bars", 1, 12, 1, nil)
	...
	GUI:CreateSwitch(characterSection, "Misc.SlotDurabilityWarning", "Show Low Durability Warnings.", "Enable this option to display a warning when your equipment's durability falls below 25%. The warning will remind you to repair your gear to avoid item breakage.")
...
local function CreateSkinsCategory()
	...
	GUI:CreateSwitch(addonSkinsSection, "Skins.Skada", L["Skada Skin"], "Apply KkthnxUI styling to Skada! damage meter")
...
local function CreateTooltipCategory()
	...
	GUI:CreateDropdown(generalTooltipSection,"Tooltip.HideInCombat", L["Hide Tooltip in Combat"], hideInCombatOptions, "Hide tooltips during combat to reduce screen clutter")

	-- Appearance
	local appearanceTooltipSection = GUI:AddSection(tooltipCategory, L["Appearance"])
	GUI:CreateSwitch(appearanceTooltipSection, "Tooltip.ItemQuality", L["Quality Color Border"], "Color tooltip borders based on item quality or unit class")
...
local function CreateUnitframeCategory()
	...
	GUI:CreateSlider(targetUnitframeSection, "Unitframe.TargetBuffsNum", "Max Buffs on Target", 3, 60, 1, "Max count of buff icons on target frame")
	GUI:CreateSlider(targetUnitframeSection, "Unitframe.TargetDebuffsNum", "Max Debuffs on Target", 3, 60, 1, "Max count of debuff icons on target frame")
...
local function CreateWorldMapCategory()
	local worldMapIcon = "Interface\\Icons\\inv_misc_map_01"
	...
	GUI:CreateSlider(sizesWorldMapSection, "WorldMap.MaxMapScale", "Fullscreen map scale", 0.1, 1, 0.1, nil)
	GUI:CreateSlider(sizesWorldMapSection, "WorldMap.MapScale", "Window map scale", 0.5, 2, 0.1, nil)
end
