...
local function CreateAuraWatchCategory()
	...
	GUI:CreateSlider(generalAuraWatchSection, "AuraWatch.MinCD", L["AuraWatch MinCD"], 1, 60, 1, L["MinCDTip"])
...
local function CreateAutomationCategory()
	...
	GUI:CreateSwitch(inviteSection, "Automation.AutoLoggingCombat", "Auto enables Combat Log in raid instances")
