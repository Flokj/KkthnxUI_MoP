...
local Inventory = function(self)
	...
	Window:CreateSwitch("Inventory", "BagsBindOnEquip", L["Display Bind Status"], L["BagsBindOnEquip Desc"], UpdateBagStatus)
...
local Chat = function(self)
	...
	-- Chat appearance
	Window:CreateSwitch("Chat", "Chatbar", newFeatureIcon .. "Show Chat Bars")
	Window:CreateSwitch("Chat", "ChatClassColor", newFeatureIcon .. "Most Class Color in Chat and chat Bubbles")
...
local DataText = function(self)
	...
	Window:CreateSwitch("DataText", "Spec", newFeatureIcon .. L["Enable Specialization Info"], L["Spec Desc"])
...
local Minimap = function(self)
	...
	Window:CreateSwitch("Minimap", "MailPulse", L["Pulse Minimap Mail"], L["MailPulse Desc"])
...
local Misc = function(self)
	...
	Window:CreateSwitch("Misc", "Focuser", newFeatureIcon .. "Mouseover focus by Alt + LeftClick")	
	Window:CreateSwitch("Misc", "HideBossEmote", L["Hide Boss Emotes"])

	Window:CreateSection("Camera")
	Window:CreateSlider("Misc", "MaxCameraZoom", "Max Camera Zoom Level", 1, 3.4, 0.1, nil, UpdateMaxZoomLevel)

	Window:CreateSection("Trade Skill")
	Window:CreateSwitch("Misc", "TradeTabs", newFeatureIcon .. L["Add Spellbook-Like Tabs On TradeSkillFrame"])
	...
	Window:CreateSwitch("Misc", "MailSaver", newFeatureIcon .. "Mail Saver (Save mail recipient)")
	...
	-- Misc Section
	Window:CreateSection(newFeatureIcon .. "Threat Bar")
...
local Tooltip = function(self)
	...
	Window:CreateSwitch("Tooltip", "SpecLevelByShift", newFeatureIcon .. L["Show Spec/ItemLevel by SHIFT"])
...
local Unitframe = function(self)
	...
	Window:CreateSlider("Unitframe", "TargetBuffsNum", newFeatureIcon .. "Max Buffs on Target", 3, 60, 1, nil, UpdateTargetBuffs)
	Window:CreateSlider("Unitframe", "TargetDebuffsNum", newFeatureIcon .. "Max Debuffs on Target", 3, 60, 1, nil, UpdateTargetDebuffs)
...
local WorldMap = function(self)
	...
	Window:CreateSwitch("WorldMap", "HideTownCityIcons", newFeatureIcon .. "Hide town and city icons on the Worldmap")
