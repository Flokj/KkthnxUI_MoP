...
local KKUI_Changelog = {
	...
	{
		Version = "[10.6.0] - 2024-12-19 - Patch 4.4.1",
	...
	{
		Version = "[10.5.7] - 2024-09-18 - Patch 4.4.0",
	...
	{
		Version = "[10.5.6] - 2024-09-08 - Patch 4.4.0",
...

	{
		...
		Sections = {

			{
				Header = "General",
				Entries = {
					"Enhanced overall addon functionality to align with the latest World of Warcraft Patch 3.4.3 updates.",
				},
			},
	...
	{
		Version = "[10.4.8] - 2023-11-22 - Patch 3.4.3",
	...
	{
		Version = "[10.4.7] - 2023-5-5 - Patch 3.4.3",
		...
		Sections = {
...

			{
				Header = "UI Updates",
				Entries = {
					"Updated the UI to align with the Dragonflight Patch 3.4.3: Embers of Neltharion Patch.",
